...
class TestTrainDatamodelsLinearRegressorWithCheckpoints:
...
class TestTrainDatamodelsLinearRegressorWithoutCheckpoints:
    ...
    def test_output_generation_train_datamodels_no_checkpoint(self):
        assert os.path.exists(f"{self.datamodels_path}/models/test_no_checkpoint")
        assert os.path.exists(f"{self.datamodels_path}/models/test_no_checkpoint/0_3_weights.pt")
        assert os.path.exists(f"{self.datamodels_path}/models/test_no_checkpoint/0_3_bias.pt")

    def test_output_sizes_no_checkpoint(self):
        weights = torch.load(f"{self.datamodels_path}/models/test_no_checkpoint/0_3_weights.pt", weights_only=True)
        bias = torch.load(f"{self.datamodels_path}/models/test_no_checkpoint/0_3_bias.pt", weights_only=True)
